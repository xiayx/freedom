...
[source%nowrap,java]
----
include::{testsourcedir}/org/freedom/associate/ForREADME.java[tag=setSingleAssociatedObjectForSingleAssociate]
----
...
[source%nowrap,java]
----
include::{testsourcedir}/org/freedom/associate/ForREADME.java[tag=setCollectionAssociatedObjectForSingleAssociate]
----
...
[source%nowrap,java]
----
include::{testsourcedir}/org/freedom/associate/ForREADME.java[tag=setSingleAssociatedNameForSingleAssociate]
----
...
[source%nowrap,java]
----
include::{testsourcedir}/org/freedom/associate/ForREADME.java[tag=setCollectionAssociatedNameForSingleAssociate]
----
...
[source%nowrap,java]
----
include::{testsourcedir}/org/freedom/associate/ForREADME.java[tag=setCollectionAssociatedObjectForCollectionAssociate]
----
...
[source%nowrap,java]
----
include::{testsourcedir}/org/freedom/associate/ForREADME.java[tag=setSingleAssociatedNameForCollectionAssociate]
----
...
[source%nowrap,java]
----
include::{testsourcedir}/org/freedom/associate/ForREADME.java[tag=setCollectionAssociatedNameForCollectionAssociate]
----
...
[source%nowrap,java]
----
include::{testsourcedir}/org/freedom/associate/ForREADME.java[tag=setAssociatedObject]
----
JpaPropertyCollectionAssociatedSource::
当关联扩展属性为实体对象的属性时使用，例如：
[source%nowrap,java]
----
include::{testsourcedir}/org/freedom/associate/ForREADME.java[tag=setAssociatedName]
----
...
[source%nowrap,java]
----
include::{testsourcedir}/org/freedom/associate/ForREADME.java[tag=setAssociatedFormatName]
----

== 引用依赖
=== 源码方式
``checkout https://github.com/xiayx/freedom.git``
